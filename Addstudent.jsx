...
class Addstudent extends React.Component {
    ...
    Addstudent = () => {
        axios.post('http://localhost:5250/api/Student', { Name: this.state.Name, RollNo: this.state.RollNo, Class: this.state.Class, Address: this.state.Address, Gender: this.state.Gender })
            .then(json => {
                ...
                <Form className="form">
                    <Col>
                        ...
                        <FormGroup row>
                            ...
                            <Col sm={10}>
                                <Input type="text" name="Address" onChange={this.handleChange} value={this.state.Gender} placeholder="Enter Gender" />
                            </Col>
                        </FormGroup>
                    </Col>
                    <Col>
